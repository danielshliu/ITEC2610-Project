...
public class Levels implements levelInterface{
    ...
    public void levelThree() {
        ...
        Enemy1 enemy1 = new Enemy1(gp, new int[]{0, 0} ,new int[]{len/2, 0}, new int[]{len, 0}, 4,3);
        gp.asteroids.add(enemy1);
        Enemy1 enemy2 = new Enemy1(gp, new int[]{len, 200} ,new int[]{len/2, 200}, new int[]{0, 200}, 3,3);
        gp.asteroids.add(enemy2);
        Enemy1 enemy3 = new Enemy1(gp, new int[]{0, 400} ,new int[]{len/2, 400}, new int[]{len, 400}, 3,3);
        gp.asteroids.add(enemy3);
        Enemy1 enemy4 = new Enemy1(gp, new int[]{len, height-100} ,new int[]{len/2, height-100}, new int[]{0, height-100}, 3,3);
        gp.asteroids.add(enemy4);
        Enemy1 enemy5 = new Enemy1(gp, new int[]{len, 520} ,new int[]{len/2, 400}, new int[]{0, 250}, 4,3);
        gp.asteroids.add(enemy5);
        ...
        gp.asteroids.add(enemy7);
        Enemy1 enemy8 = new Enemy1(gp, new int[]{0, 520} ,new int[]{len/2, 300}, new int[]{len, 300}, 4,3);
        gp.asteroids.add(enemy8);
        Enemy1 enemy;
        enemy = new Enemy1(gp, new int[]{100, height+100} ,new int[]{len/2, 300}, new int[]{len, 0}, 4,3);
        gp.asteroids.add(enemy);
        enemy = new Enemy1(gp, new int[]{0, -100} ,new int[]{len/2, 300}, new int[]{len, height}, 4,3);
        gp.asteroids.add(enemy);
    }
    ...
    public void levelThreeWave2(){
        ...
        gp.asteroids.add(enemy2);
        Enemy1 enemy3 = new Enemy1(gp, new int[]{len, 400} ,new int[]{len/2, 400}, new int[]{0, 400}, 4,3);
        gp.asteroids.add(enemy3);
        ...
        gp.asteroids.add(enemy5);
        Enemy1 enemy6 = new Enemy1(gp, new int[]{0, 520} ,new int[]{300, height/2}, new int[]{len, 300}, 4,3);
        gp.asteroids.add(enemy6);
        Enemy1 enemy7 = new Enemy1(gp, new int[]{len, 520} ,new int[]{len/2, 400}, new int[]{0, 250}, 3,3);
        gp.asteroids.add(enemy7);
        ...
        enemy = new Enemy1(gp, new int[]{100, height+100} ,new int[]{len/2, 300}, new int[]{len, 0}, 4,3);
        gp.asteroids.add(enemy);
        enemy = new Enemy1(gp, new int[]{0, 0} ,new int[]{len/2, 300}, new int[]{len-200, height+300}, 4,3);
        gp.asteroids.add(enemy);
        setWave(3.2);
    }
    public void levelThreeWave3(){
        ...
        Enemy1 enemy6 = new Enemy1(gp, new int[]{0, 520} ,new int[]{300, height/2}, new int[]{len, 300}, 3,3);
        gp.asteroids.add(enemy6);
        Enemy1 enemy7 = new Enemy1(gp, new int[]{len, 520} ,new int[]{len/2, 400}, new int[]{0, 250}, 4,3);
        gp.asteroids.add(enemy7);
        ...
        gp.asteroids.add(enemy9);
        Enemy1 enemy10 = new Enemy1(gp, new int[]{0, 200} ,new int[]{len/2, 400}, new int[]{len, 200}, 4,3);
        gp.asteroids.add(enemy10);
        Enemy1 enemy11 = new Enemy1(gp, new int[]{len, 400} ,new int[]{len/2, 300}, new int[]{0, 400}, 4,3);
        ...
        enemy = new Enemy1(gp, new int[]{0, 100} ,new int[]{len/2, 300}, new int[]{len, height}, 4,3);
        gp.asteroids.add(enemy);
        enemy = new Enemy1(gp, new int[]{len-100, height+100} ,new int[]{len/3, 300}, new int[]{0, 0}, 4,3);
        gp.asteroids.add(enemy);
        enemy = new Enemy1(gp, new int[]{0, height} ,new int[]{len/2, height/2-100}, new int[]{len-200, height+300}, 4,3);
        gp.asteroids.add(enemy);
        setWave(0);
    }
    @Override
    ...
    public void levelFourWave2(){
        Enemy1 enemy;
        for (int i = 0; i <= Game.tileSize*11; i += Game.tileSize * 1.5){
            enemy = new Enemy1(gp, new int[]{len, i} ,new int[]{len/2, i}, new int[]{0, i}, 3,4);
            gp.asteroids.add(enemy);
        }
        Enemy1 enemy1 = new Enemy1(gp, new int[]{0, 400} ,new int[]{300, 200}, new int[]{len, 300}, 3,4);
        gp.asteroids.add(enemy1);
        Enemy1 enemy2 = new Enemy1(gp, new int[]{len, 200} ,new int[]{300, 100}, new int[]{0, 360}, 3,4);
        gp.asteroids.add(enemy2);
        Enemy1 enemy3 = new Enemy1(gp, new int[]{len, 520} ,new int[]{300, 400}, new int[]{0, 100}, 4,4);
        gp.asteroids.add(enemy3);
        Enemy1 enemy4 = new Enemy1(gp, new int[]{0, 400} ,new int[]{300, 200}, new int[]{len, 300}, 4,4);
        gp.asteroids.add(enemy4);
        Enemy1 enemy5 = new Enemy1(gp, new int[]{0, 100} ,new int[]{300, 400}, new int[]{len, 250}, 3,4);
        gp.asteroids.add(enemy5);
        Enemy1 enemy6 = new Enemy1(gp, new int[]{0, 600} ,new int[]{300, 400}, new int[]{len, 300}, 4,4);
        gp.asteroids.add(enemy6);
        Enemy1 enemy7 = new Enemy1(gp, new int[]{0, 400} ,new int[]{300, 200}, new int[]{768, 300}, 3,4);
        gp.asteroids.add(enemy7);
        Enemy1 enemy8 = new Enemy1(gp, new int[]{len, 200} ,new int[]{300, 400}, new int[]{0, 360}, 3,4);
        ...
        Enemy1 enemy9 = new Enemy1(gp, new int[]{len, 520} ,new int[]{300, 500}, new int[]{500, 100}, 3,4);
        gp.asteroids.add(enemy9);
        enemy = new Enemy1(gp, new int[]{0, height} ,new int[]{len/2, height/2-100}, new int[]{len-200, height+300}, 4,4);
        gp.asteroids.add(enemy);
        if (gp.level == 4.4){
            setWave(0);
        } else{
    ...
    public void levelFourWave4(){
        Enemy1 enemy;
        for (int i = 0; i <= Game.tileSize*11; i += Game.tileSize * 2){
            enemy = new Enemy1(gp, new int[]{len, i} ,new int[]{len/2, i}, new int[]{0, i}, 2,4);
            gp.asteroids.add(enemy);
            enemy = new Enemy1(gp, new int[]{0, i} ,new int[]{len/2, i}, new int[]{len, i}, 2,4);
            gp.asteroids.add(enemy);
        ...
        for (int i = 0; i <= Game.tileSize*11; i += Game.tileSize * 1.5){
            enemy = new Enemy1(gp, new int[]{len, i} ,new int[]{len/2, i}, new int[]{0, i}, 1,4);
            gp.asteroids.add(enemy);
            enemy = new Enemy1(gp, new int[]{0, i} ,new int[]{len/2, i}, new int[]{len, i}, 1,4);
            gp.asteroids.add(enemy);
            setWave(4.4);
        }
        for (int i = 0; i <= Game.tileSize*11; i += Game.tileSize * 4){
            enemy = new Enemy1(gp, new int[]{len, i} ,new int[]{len/2, i}, new int[]{0, i}, 3,4);
            gp.asteroids.add(enemy);
            enemy = new Enemy1(gp, new int[]{0, i} ,new int[]{len/2, i}, new int[]{len, i}, 3,4);
            gp.asteroids.add(enemy);
            setWave(4.4);
        }
    }
